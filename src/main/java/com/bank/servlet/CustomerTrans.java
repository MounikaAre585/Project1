...
/**
 * Servlet implementation class CustomerTrans
 */
public class CustomerTrans extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i=0;i<li.size();i++) {
			...
			int amo=li.get(i).getAmount();
			String type=li.get(i).getType();
			
			out.println("<tr><td>" + caccno + "</td><td>"+ camonut+ "</td><td>"+ amo +"</td><td>" + type + "</td></tr>"); 
